...
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (1,'VISA','4929572022388241','59038750','03/22', '800', 325, '1')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (2,'VISA','4024007113758386','43642155','05/26', '320', 300, '0')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (3,'VISA','4064951284462602','18126721', '06/22', '421', 600, '1')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (4,'VISA','4539063123650335','06024293', '10/25', '634', 245, '1')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (5,'VISA','4024007163752297','99825603', '02/23', '921', 15, '1')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (6,'VISA','4916054967849649','91122063', '08/28', '457', 3200, '0')
INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES (7,'VISA','4024007141425909','88433786', '11/24', '670', 77, '1')
...
/* Join Demonstration for returning all Appointments*/
...
FROM TBL_APPOINTMENTS AS App LEFT JOIN TBL_PAYMENT AS Pay ON (Pay.AppointmentNo = App.AppointmentNo),
	TBL_ADDRESS AS Add1 ,
	TBL_ADDRESS AS Add2,
	TBL_DATE AS Date,
	TBL_PATIENTS AS Pat,
...
--Rollback Transaction for New Private patient Appointment and update direct debit details
BEGIN TRANSACTION AddPrivatePatientAppointment
	BEGIN TRY -- add try to catch errors
	--Add new private patient
	INSERT INTO TBL_APPOINTMENTS (PatientNo, StaffNo, SurgeryNo, DateNo, Comment) VALUES (9,1,1,7,'Follow up appointment');
	INSERT INTO TBL_PAYMENT (AppointmentNo, CardType, CardNumber, SortCode, ExpiryDate, SecurityCode, Amount, Settled) VALUES ((SELECT MAX(TBL_APPOINTMENTS.AppointmentNo) FROM TBL_APPOINTMENTS),'VISA','4024007141425909','88433786', '11/24', '800', 77, '1');
	END TRY
BEGIN CATCH
	-- Rollback Insert statements and display error.
	ROLLBACK TRANSACTION AddPrivatePatientAppointment
	PRINT('Rolling back, en error occured!');
END CATCH;

--Returns an error because same patient same staff, same surgery, same time. roll back update.
...
--https://numbergenerator.org/random-8-digit-number-generator
-- Mock Bank card details
--https://www.creditcardvalidator.org/generator
